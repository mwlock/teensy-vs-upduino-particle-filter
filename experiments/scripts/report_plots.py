...
# Convert memory usage to kB from bits
mem_usage_upduni = mem_usage_upduni/8/1000

labels = [str(x) for x in num_particles_list]

ax.bar(labels, memory_usage_list, label='Teensy 4.1')
